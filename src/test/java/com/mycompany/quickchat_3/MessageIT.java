...
public class MessageIT {
    ...
    public void testCheckRecipientCell() {
        ...
        String cell = "";
        String expResult = "";
        String result = Message.checkRecipientCell(cell);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    /**
     * Test of checkMessageHash method, of class Message.
     */
    @Test
    public void testCheckMessageHash() {
        System.out.println("checkMessageHash");
        String messageID = "";
        String message = "";
        String expResult = "";
        String result = Message.checkMessageHash(messageID, message);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testSendMessage() {
        ...
        String message = "";
        String expResult = "";
        String result = Message.sendMessage(choice, message);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
